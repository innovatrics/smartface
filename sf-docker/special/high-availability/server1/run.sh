...
docker exec -it rmq1 /opt/rabbitmq/sbin/rabbitmqctl add_user mqtt mqtt || true
docker exec -it rmq1 /opt/rabbitmq/sbin/rabbitmqctl set_user_tags mqtt administrator || true
docker exec -it rmq1 /opt/rabbitmq/sbin/rabbitmqctl set_permissions -p "/" mqtt ".*" ".*" ".*" || true

docker exec -it rmq1 /opt/rabbitmq/sbin/rabbitmqctl stop_app
docker exec -it rmq1 /opt/rabbitmq/sbin/rabbitmqctl reset
docker exec -it rmq1 /opt/rabbitmq/sbin/rabbitmqctl start_app
